...
public class MenuController {
    ...
    public String getMenu(HttpServletRequest request) {
		...
		if (1 == level) {
			...
			array.add(getJsonObject("messageInfo", "在线留言", "layui-icon-table", "messageInfo"));
			array.add(getJsonObject("checkInfo", "人员检测信息", "layui-icon-table", "checkInfo"));
			array.add(getJsonObject("submitInfo", "评估考核", "layui-icon-table", "submitInfo"));
			array.add(getJsonObject("richtextInfo", "站内新闻", "layui-icon-table", "richtextInfo"));
			array.add(getJsonObject("advertiserInfo", "公告信息", "layui-icon-table", "advertiserInfo"));
			array.add(getJsonObject("typeInfo", "绩效类型", "layui-icon-table", "typeInfo"));
			array.add(getJsonObject("goodsInfo", "绩效考核发布", "layui-icon-table", "goodsInfo"));
			array.add(getJsonObject("orderInfo", "订单信息", "layui-icon-table", "orderInfo"));
			array.add(getJsonObject("commentInfo", "意见征集", "layui-icon-table", "commentInfo"));
